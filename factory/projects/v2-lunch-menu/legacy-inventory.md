...
| `schoolLunch.ts:346-352` — 5 seeds | 条件を見ながら入れかえる／代わりを考える／… | **UPGRADE to 3** | Ver.2 keeps the two that match what the child actually did (組み合わせを考える／予定が変わって考え直す) and adds the teaching side (食べることを人に伝える). |
