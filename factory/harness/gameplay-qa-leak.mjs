...
// ---- 4. rules and budgets ----
{
  ...
  check("REGRESSION (design r5): the house distractor is silent too while its segment is closed", (() => { const cc = { leak: { seg: "A", point: 1 }, house: { seg: "C", point: 2 } }; const open = soundReading(cc, "C", 2, null); const shut = soundReading(cc, "C", 2, "C"); return open.level === 4 && open.continuity === "intermittent" && shut.level === 1 && shut.continuity === "steady"; })());
