#!/usr/bin/env node
// Independent Codex art-ownership classification (2026-09-04 directive §15).
...
const prompt = readFileSync("factory/harness/art-ownership-audit-prompt.md", "utf8");
const shots = [
  "factory/state/art/map-repair-shots/mobile-01-initial.png",
  "factory/state/art/map-repair-shots/desktop-01-initial.png",
  "factory/state/art/map-repair-shots/mobile-04-district-selected.png",
];
const replyFile = join(mkdtempSync(join(tmpdir(), "jc-artaudit-")), "reply.txt");
...
writeFileSync("factory/state/art/art-ownership-codex-audit.json", JSON.stringify(result, null, 1));
