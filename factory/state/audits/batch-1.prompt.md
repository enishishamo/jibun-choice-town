...
- place_and_test (ParkHeatGame) — src/q1/ParkHeatGame.tsx [猛暑編]
- forecast_and_balance (PowerGame) — src/q1/PowerGame.tsx [猛暑編]
- schedule_and_protect (SiteHeatGame) — src/q1/SiteHeatGame.tsx [猛暑編]
- allocate_and_forecast (WaterGame) — src/q1/WaterGame.tsx [猛暑編]
- layer_and_compare (UrbanHeatGame) — src/q1/UrbanHeatGame.tsx [猛暑編]
