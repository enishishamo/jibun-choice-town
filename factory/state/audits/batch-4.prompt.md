...
- clue_board (ClueBoardGame) — src/q1/ClueBoardGame.tsx [医療編（1人の患者を9章で追う）]
- lab_check (LabCheckGame) — src/q1/LabCheckGame.tsx [医療編（1人の患者を9章で追う）]
- xray_shoot (XrayGame) — src/q1/XrayGame.tsx [医療編（1人の患者を9章で追う）]
- clue_join (DiagnoseGame) — src/q1/DiagnoseGame.tsx [医療編（1人の患者を9章で追う）]
- rx_check (RxCheckGame) — src/q1/RxCheckGame.tsx [医療編（1人の患者を9章で追う）]
