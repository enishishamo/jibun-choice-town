  ...
  professions: [
    {
      ...
      related: ["動物園の｜獣医師《じゅういし》", "水族館の飼育スタッフ", "牧場の仕事"],
    },
    {
      id: "zoo-vet",
      name: "動物園の獣医師",
      ...
      related: ["動物病院の｜獣医師《じゅういし》", "野生動物の保護の仕事", "飼育員"],
    },
    {
      id: "zoo-nutritionist",
      name: "動物園の栄養担当（餌づくり）",
      ...
      q2: [
        {
          ...
          body: [
            ...
            "｜授乳中《じゅにゅうちゅう》（お乳をあげている）のおかあさんには増量、赤ちゃんは体重に合わせてミルクの量を変える——規則を毎日のデータに当てはめるのが腕の見せどころです。",
          ],
        },
        {
          id: "himitsu", title: "実は！", icon: "💡",
