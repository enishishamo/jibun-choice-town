...
export const schoolLunch: ContentModule = {
  ...
  experiences: [
    ...
    // ============ 給食の食材を届ける仕事 ============
    {
      ...
      seeds: ["温度や時間の条件を守る", "順番ややり方を組み立てる", "一度で正しく判断する", "とくにない"],
    },
    // ============ 食べ残しを資源に変える工場 ============
    {
      id: "recycle-lunch",
      ...
      mission: {
        title: "食べ残しが工場に届いた。\nでも、このままではリサイクルできない！",
        lines: ["異物を観察してから、性質に合う道具を選んで取りのぞこう。"],
      },
      tools: [],
      resolution: {
        title: "きれいになった食べ残しが、\n資源に変わっていく！",
      ...
      discoveryEcho:
        "さっき、異物の性質を観察してから、磁選機・風力選別・手選別を使い分けたよね。工場では、こうやって道具の物理的な原理をいかして、食べ残しを安全な肥料に変えています。",
