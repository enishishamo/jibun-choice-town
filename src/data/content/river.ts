...
export const river: ContentModule = {
  ...
  events: [
    {
      ...
      lensSummary: {
        ...
        rows: [
          ...
          { icon: "🫧", label: "処理場", view: "微生物のきげんと電力。多すぎもだめ" },
      ...
      wrapUp: {
        beforeAfter: {
          ...
          afterLabel: "いま：瀬と淵に、魚のかげ",
        },
        title: "魚がもどったのは、ひとつの奇跡じゃなかった。",
        lines: [
          "毎日の処理場の運転、地道な調査、守る場所をしぼった川づくり。ぜんぶが少しずつ効いた。",
          "「魚を見た」の一言を記録に変えた、川ぞいを歩く人たちの目も。",
      ...
      q2: [
        {
          ...
          body: [
            ...
            "家のうしろやけずられた場所はしっかり守り、それ以外は川の自然な流れにまかせるのが、いまの考え方です。",
          ],
        },
        {
          id: "himitsu", title: "実は！", icon: "💡",
          body: [
            "魚道は「つければ通れる」ではありません。魚の体の大きさ、泳ぐ力、のぼる季節に合わせて設計しないと、入り口さえ見つけてもらえないんです。",
          ],
        },
        {
          id: "who", title: "だれがやっている？", icon: "🧩", body: [],
  ...
  experiences: [
    ...
    },
    {
      ...
      tools: [
        { id: "map", name: "川の図面", emoji: "🗺", desc: "侵食のあとと土地利用" },
        { id: "works", name: "工法カタログ", emoji: "📐", desc: "護岸・石積み・魚道" },
        { id: "budget", name: "予算表", emoji: "💰", desc: "ぜんぶは固められない" },
      ],
      resolution: {
        clock: "会議のあと",
        title: "図面が、川の未来になる",
        lines: ["工事が終わるころ、瀬と淵に生きものがもどる。"],
      },
