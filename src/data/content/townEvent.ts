...
export const townEvent: ContentModule = {
  ...
  experiences: [
    ...
    },
    {
      ...
      mission: {
        title: "まだ、だれも知らない！",
        lines: ["今回の重点対象と状況を見て、3つのプラン案を比べよう。"],
      },
      tools: [],
      resolution: { title: "広報プランが、動き出した！", lines: [] },
      discoveryEcho:
        "さっき、今回の重点対象と状況を確かめて、3つのプラン案を比べて選んだよね。こうやって今回に合う伝え方を見きわめるのが、広報・PRの大事な仕事のひとつです。",
      seeds: ["人にどう届くか考える", "プランを比べて選ぶ", "結果を見てやり直す", "だれのためか考える", "特にない"],
    },
    {
      id: "run-event",
