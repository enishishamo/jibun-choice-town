...
export const schoolTrip: ContentModule = {
  ...
  professions: [
    ...
    },
    {
      id: "trip-hotel",
      name: "ホテル・旅館の団体受入担当",
      catch: "届いた班情報を、部屋・食事で受け止める",
      image: T("school-trip-hotel"),
      discoveryLine: "学校から届いた班の情報をもとに、部屋の確認と\nアレルギー対応を組み立てる仕事！",
      q2: [
        { id: "what", title: "どんな仕事？", icon: "🏮",
          body: ["学校や旅行会社から届いた班の人数を確認し、提示された部屋の定員で足りるかを判定します。",
                 "アレルギー事前調査票を一人ひとり確認し、対応が必要な人だけに個別の食事を手配します。"] },
        ...
        { id: "himitsu", title: "実は！", icon: "💡",
          body: ["班そのものは学校が作ったもの。宿の仕事は、その班を実際に空いている部屋・一人ひとりのアレルギー対応へ、うまく収めることです。"] },
      ],
  ...
  experiences: [
    ...
    },
    {
      ...
      seeds: ["情報を確認する", "定員を確かめる", "配慮を反映する", "見落とさない", "特にない"],
    },
  ],
};
