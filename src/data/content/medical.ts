...
export const medical: ContentModule = {
  ...
  professions: [
    {
      ...
      q2: [
        { id: "what", title: "どんな仕事？", icon: "🩺",
          body: ["患者さんの話を聞き、からだを診て、必要な検査を考えて、何が起きているかを見きわめます（診断）。",
      ...
      related: ["看護師", "薬剤師", "臨床検査技師", "研究", "公衆衛生"],
    },
    {
      id: "labtech",
      name: "臨床検査技師",
      catch: "からだの中を、信頼できる数字にする",
      image: M("who_labtech"),
      discoveryLine: "届いた検体を、からだの中を知るための\n確かな情報に変える仕事！",
      q2: [
        { id: "what", title: "どんな仕事？", icon: "🔬",
          body: ["血液や尿などを調べて、からだの中で何が起きているかを数字にします。",
                 "「その結果が本当に信じられるか」を確かめるのも大事な仕事です。"] },
        { id: "kinds", title: "検査もいろいろ", icon: "🧩", body: [],
          list: ["血液や尿の検査", "細菌の検査", "心電図・超音波などの生理検査", "検査機器の管理", "…など"] },
        { id: "become", title: "どうやったらなれる？", icon: "🎓",
          body: ["大学や専門学校で学び、国家試験に合格します。"] },
        { id: "himitsu", title: "実は！", icon: "💡",
          body: ["同じ「異常な数字」でも、検体の扱い方が原因のこともあります。だから結果を出す前に、検体の状態や測り直しを確認します。"] },
      ],
    ...
    },
    {
      id: "radtech",
      name: "診療放射線技師",
      catch: "外から見えないところを、画像にする",
      image: M("who_radtech"),
      discoveryLine: "からだの向きや範囲を考えて、\n診断に使える画像をつくる仕事！",
      q2: [
        { id: "what", title: "どんな仕事？", icon: "🩻",
          body: ["X線やCT、MRIなどの装置を使って、からだの中を画像にします。",
                 "ただ撮るのではなく、診断に使える写りになるように位置や条件を整えます。"] },
        { id: "kinds", title: "いろんな装置", icon: "🧩", body: [],
          list: ["X線撮影", "CT", "MRI", "超音波", "放射線を使う治療の担当", "…など"] },
        { id: "become", title: "どうやったらなれる？", icon: "🎓",
          body: ["大学や専門学校で学び、国家試験に合格します。"] },
        { id: "himitsu", title: "実は！", icon: "💡",
          body: ["同じ人を撮っても、向きや息の止め方で写り方が変わります。放射線の量をできるだけ少なくすることも大切にしています。"] },
      ],
    ...
    },
    {
      ...
      q2: [
        { id: "what", title: "どんな仕事？", icon: "💊",
          body: ["処方された薬が、その人にとって安全で効くように確かめます。",
        ...
        { id: "himitsu", title: "実は！", icon: "💡",
          body: ["同じ薬でも、その人の体重・年齢・腎臓や肝臓のはたらきによって、ちょうどよい量がちがうことがあります。"] },
      ],
    ...
    },
    {
      ...
      q2: [
        ...
        { id: "kinds", title: "リハビリの仲間", icon: "🧩", body: [],
          list: ["理学療法士（動作）", "作業療法士（生活の動作・手仕事）", "言語聴覚士（話す・食べる）", "…など"] },
        { id: "become", title: "どうやったらなれる？", icon: "🎓",
          body: ["大学や専門学校で学び、国家試験に合格します。"] },
        { id: "himitsu", title: "実は！", icon: "💡",
          body: ["ゴールは「歩けること」ではなく、「その人がしたい生活ができること」。だから家の様子や普段の一日も聞きます。"] },
      ],
      related: ["作業療法士", "言語聴覚士", "看護", "スポーツ", "福祉用具"],
    },
    {
      id: "msw",
      ...
      q2: [
        ...
        { id: "kinds", title: "つなぐ相手", icon: "🧩", body: [],
          list: ["本人・家族", "ケアマネジャー", "訪問看護・介護のサービス", "行政の窓口", "地域の相談機関", "…など"] },
        { id: "become", title: "どうやったらなれる？", icon: "🎓",
          body: ["社会福祉士などの資格をとって働く人が多い仕事です（職場によって条件はちがいます）。"] },
        { id: "himitsu", title: "実は！", icon: "💡",
          body: ["「安全だから」と支援を増やせばいいわけではありません。その人がどう暮らしたいかを、いちばん大事にします。"] },
      ],
      related: ["社会福祉士", "ケアマネジャー", "行政", "地域包括支援センター", "介護"],
    },
  ],
  ...
  experiences: [
    ...
    },
    {
      ...
      place: { name: "検査室", image: M("lab"), fit: "cover", focus: "center 42%" },
      mission: { title: "この血液から、\n何が分かるだろう？", lines: ["からだの中を知るための、確かな情報にしよう。"] },
      tools: [], resolution: { title: "結果を、医師へ報告した", lines: [] },
      discoveryEcho: "さっき、届いた検体を確かめて、その結果を信じていいかまで確認したよね。からだの中を確かな情報にするのが、この仕事です。",
      seeds: ["小さな違いを確認する", "数字を見る", "正確に調べる", "結果を確かめる", "特にない"],
    },
    {
      id: "med-radio", professionId: "radtech", eventId: "er-patient", gameType: "xray_shoot",
      place: { name: "X線撮影室", image: M("xray_room"), fit: "cover", focus: "center 45%" },
      mission: { title: "外からは見えない\n肺の中を見たい", lines: ["診断に使える画像を撮ろう。"] },
      tools: [], resolution: { title: "肺全体が写った画像ができた", lines: [] },
      discoveryEcho: "さっき、身体の位置や撮影範囲を考えて、肺を診断に使える画像にしたよね。見えないところを画像にするのが、この仕事です。",
      seeds: ["機械を使う", "位置を調整する", "画像を見る", "うまくいくまで試す", "特にない"],
    },
    {
      ...
      discoveryEcho: "さっき、話・からだ・検査・画像をつなげて、ばらばらの手がかりを1つの見立てにまとめたよね。これが診断につながる考え方です。",
    ...
    },
    {
      ...
      place: { name: "退院前の面談", image: M("msw_room"), fit: "cover", focus: "center 45%" },
      mission: { title: "「家に帰りたい。」", lines: ["でも、ひとり暮らし。まず何から聞こう？"] },
      tools: [], resolution: { title: "退院後のくらしが、つながった", lines: [] },
      discoveryEcho: "さっき、この人がどんな暮らしをしたいか聞いて、生活の困りごとと支援をつないだよね。それがMSWの仕事です。",
      seeds: ["人の話を聞く", "生活を想像する", "困りごとを整理する", "人やサービスをつなぐ", "特にない"],
    },
  ],
};
