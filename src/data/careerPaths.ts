...
export const CAREER_PATHS: Record<string, CareerPath> = {
        ...
        "steps": [
          {
            ...
            "required": true,
            "description": "高校で理科や数学をがんばって医学部を目指す"
          },
          {
            "stage": "大学医学部医学科（6年）",
            "requirementType": "education",
  ...
  "labtech": {
    "qualificationRequired": true,
    "qualificationName": "｜臨床検査技師《りんしょうけんさぎし》免許（｜国家資格《こっかしかく》）",
    "pathSummary": "文部科学大臣指定の大学・短大や都道府県知事指定の養成所で3年以上学び、｜臨床検査技師《りんしょうけんさぎし》｜国家試験《こっかしけん》に合格して免許を取得する。心電図・超音波などの一部の生理学的検査は法律で｜臨床検査技師《りんしょうけんさぎし》などの有資格者に限定されており、医療機関での検体検査も基本的に有資格者が担当する。",
    "routes": [
      {
        ...
        "steps": [
          {
            ...
            "requirementType": "education",
            "required": true,
            "description": "高校を出て検査の専門学校や大学をめざす"
          },
          {
    ...
    "canStartLater": true,
    "importantNotes": "｜臨床検査技師《りんしょうけんさぎし》は｜国家資格《こっかしかく》。心電図・超音波などの一部の生理学的検査は法律で｜臨床検査技師《りんしょうけんさぎし》などの有資格者に限定されている（すべての検体検査を一律に独占しているわけではない）。すでに大人になってから｜養成校《ようせいこう》（3年制専門学校など）に入学し直して目指すことも可能。",
    "factSources": [
      ...
      },
      {
        ...
        "steps": [
          ...
          },
          {
            ...
            "required": true,
            "description": "働きながら、正｜看護師《かんごし》になるための学校（2年間）に通って卒業をめざす"
          },
          {
            "stage": "｜看護師《かんごし》｜国家試験《こっかしけん》",
            "requirementType": "exam",
  ...
  "dietitian": {
    ...
    "routes": [
      ...
      },
      {
        ...
        "steps": [
          ...
          {
            "stage": "｜実務経験《じつむけいけん》（｜養成施設《ようせいしせつ》の年数に応じて2〜3年以上）",
            "requirementType": "experience",
            "required": true,
            "description": "栄養士として働きながら経験を積む"
          },
          {
            "stage": "｜管理栄養士《かんりえいようし》｜国家試験《こっかしけん》",
            "requirementType": "exam",
    ...
    "canStartLater": true,
    "importantNotes": "『栄養士』と『｜管理栄養士《かんりえいようし》』は別の資格で、｜管理栄養士《かんりえいようし》の方が上位の｜国家資格《こっかしかく》（名称独占）。誤解されやすいが、｜管理栄養士《かんりえいようし》になるために必ず先に栄養士として現場で長く働く必要があるわけではなく、4年制の｜管理栄養士《かんりえいようし》｜養成課程《ようせいかてい》を卒業すれば｜実務経験《じつむけいけん》なしで｜国家試験《こっかしけん》を受けられる道が今は主流。栄養士として働き始めてから｜管理栄養士《かんりえいようし》を目指す『途中からのルート』も存在する。",
    "factSources": [
        ...
        "steps": [
          {
            ...
            "requirementType": "education",
            "required": true,
            "description": "まずはふつうに中学校を卒業するよ。"
          },
          {
            "stage": "高校（普通科でも農業・林業系専門学科でも可）",
            "requirementType": "education",
            "required": false,
            "description": "森や林業のことを学べる高校もあるけど、ふつうの高校でも大丈夫。"
          },
          {
  ...
  "river-operator": {
    "qualificationRequired": false,
    "qualificationName": "｜公害防止管理者《こうがいぼうしかんりしゃ》（水質関係、区分は処理水量により第1種〜第4種）※施設の規模による選任義務であり、現場の運転員全員が必ず保有する必要はない",
    "pathSummary": "下水処理場の運転管理そのものは未経験からOJTで始められる仕事だが、施設の業種区分や規模によっては、「特定工場における公害防止組織の整備に関する法律」により水質関係｜公害防止管理者《こうがいぼうしかんりしゃ》の選任が法律で義務づけられる場合がある（すべての下水処理施設に一律に適用される制度ではない）。対象になる場合は、｜国家試験《こっかしけん》合格または資格認定講習の修了で取得する。",
    "routes": [
      {
        ...
        "steps": [
          ...
          },
          {
            ...
            "requirementType": "license",
            "required": false,
            "description": "施設によっては、水をきれいにする専門の資格を持った人を置かないといけない決まりがあるよ。試験に合格するか、講習を受けて資格を取るよ。"
          }
        ]
      }
    ],
    ...
    "canStartLater": true,
    "importantNotes": "「｜公害防止管理者《こうがいぼうしかんりしゃ》」の選任義務は施設の業種区分や規模によって決まり、すべての下水処理施設に一律に必要というわけではない。対象になる場合でも、現場の運転員全員がこの資格を持つ必要はなく、未取得のまま｜実務経験《じつむけいけん》を積み、途中で取得するのが一般的。",
    "factSources": [
  ...
  "incinerator-operator": {
    ...
    "canStartLater": true,
    "importantNotes": "『焼却炉を動かす人は全員｜国家資格《こっかしかく》が必要』という誤解をしないよう注意。法律が義務付けているのは施設単位での技術管理者の設置であり、現場の日常運転業務自体は無資格からのOJTで始められる。",
    "factSources": [
  ...
  "env-measurer": {
    "qualificationRequired": false,
    "qualificationName": "｜公害防止管理者《こうがいぼうしかんりしゃ》（大気関係、区分は排出ガス量により第1種〜第4種）※施設の規模による選任義務",
    "pathSummary": "清掃工場や工場の排ガスを測定・管理する業務は、大気汚染防止法・特定工場における公害防止組織の整備に関する法律に基づき、一定規模以上の施設で大気関係｜公害防止管理者《こうがいぼうしかんりしゃ》の選任が法律で義務付けられている。未経験から測定補助の実務に就き、資格を取得してキャリアアップするのが一般的。",
    "routes": [
      {
        ...
        "steps": [
          ...
          },
          {
            ...
            "requirementType": "license",
            "required": false,
            "description": "大きな施設では、空気のきれいさを管理する専門の｜国家資格《こっかしかく》を持った人を必ず置かないといけない決まりがあるよ。"
          }
        ]
      }
    ],
    ...
    "canStartLater": true,
    "importantNotes": "｜公害防止管理者《こうがいぼうしかんりしゃ》は施設の規模（排出ガス量・排出水量）によって選任義務の有無・区分（第1種〜第4種等）が変わる点に注意。すべての工場・施設に一律で必要というわけではない。",
    "factSources": [
  ...
  "landfill-manager": {
    ...
    "canStartLater": true,
    "importantNotes": "管理者（施設の技術統括責任者）としてこの資格が必須である一方、処分場での日常的な現場作業員全員がこの資格を持つ必要はない。管理者になる段階で取得するのが実態に近い。",
    "factSources": [
  ...
  "nutrition": {
    "qualificationRequired": true,
    "qualificationName": "｜栄養教諭《えいようきょうゆ》免許状（｜国家資格《こっかしかく》・｜教員免許《きょういんめんきょ》の一種）または栄養士・｜管理栄養士《かんりえいようし》資格（｜学校栄養職員《がっこうえいようしょくいん》の場合）",
    "pathSummary": "学校給食の栄養にかかわる仕事には「｜栄養教諭《えいようきょうゆ》」と「｜学校栄養職員《がっこうえいようしょくいん》」の2種類があり、両者は必要資格も役割も異なる。｜栄養教諭《えいようきょうゆ》は児童生徒に食育の授業を行える教員であり、｜栄養教諭《えいようきょうゆ》免許状（｜教員免許《きょういんめんきょ》の一種）が必要。｜学校栄養職員《がっこうえいようしょくいん》は栄養士・｜管理栄養士《かんりえいようし》として給食管理を行うが、教壇に立って授業をすることはできない。",
    "routes": [
      {
  ...
  "recycle": {
    ...
    "alternatives": "事業所全体としては「登録再生利用事業者」制度（食品リサイクル法に基づく農林水産大臣等の登録）があるが、これは会社・事業所単位の登録であり、現場の一般作業員個人が資格を持つ必要はない。",
    "canStartLater": true,
  ...
  "trip-conductor": {
    ...
    "pathSummary": "修学旅行などの団体旅行に同行し旅程を管理する添乗員として業務を行うには、旅行業法上「｜旅程管理主任者《りょていかんりしゅにんしゃ》」の資格が必要になる場合が多い（一定規模以上の募集型企画旅行等で主任の添乗員として同行する場合）。国内旅行のみを扱う「国内｜旅程管理主任者《りょていかんりしゅにんしゃ》」と、海外も扱える「総合｜旅程管理主任者《りょていかんりしゅにんしゃ》」がある。",
    "routes": [
      {
    ...
    "alternatives": "｜旅程管理主任者《りょていかんりしゅにんしゃ》資格を持たない添乗員が同行できる旅行もあるが（一定の小規模な旅行等）、多くの学校の修学旅行のような募集型・受注型企画旅行では有資格者の同行が必要になる場面が多い。",
    "canStartLater": true,
  ...
  "food-inspector": {
    "qualificationRequired": true,
    "qualificationName": "｜食品衛生監視員《しょくひんえいせいかんしいん》｜任用資格《にんようしかく》（｜国家資格《こっかしかく》ではなく、食品衛生法施行令第9条に基づく｜任用資格《にんようしかく》）＋地方公務員採用試験（都道府県・保健所設置市等）合格",
        ...
        "steps": [
          {
            ...
            "requirementType": "education",
            "required": false,
            "description": "大学で決まった勉強をして卒業する道と、栄養士として経験を積む道など、いくつかの道があるよ。"
          },
          {
            "stage": "公務員試験・採用試験",
            "requirementType": "exam",
    ...
    "routes": [
      ...
      },
      {
        ...
        "steps": [
          ...
          {
            "stage": "｜雑踏警備業務検定《ざっとうけいびぎょうむけんてい》2級・1級の取得（任意、ただし一部現場で必須）",
            "requirementType": "license",
            "required": false,
            "description": "この検定は必須じゃないけど、すごく混雑が予想される場所では『検定に受かった警備員』を置かなければいけない決まりがあることもあるよ。"
          }
        ]
      }
    ],
